  ...
  return (
    <Dialog open={openDialog} onOpenChange={setOpenDialog}>
      ...
      >
        ...
        <div className="relative overflow-x-auto overflow-y-auto px-6 space-y-8 max-h-[calc(90vh-200px)]">
          <Table className="text-gray-800 bg-white border border-indigo-200 rounded-xl overflow-hidden shadow-[0_8px_24px_rgba(75,_85,_99,_0.15)]">
