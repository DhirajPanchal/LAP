  ...
  return (
    <Dialog open={openDialog} onOpenChange={setOpenDialog}>
      ...
      >
        ...
        <div className="overflow-hidden border border-indigo-300 rounded-xl">
          <Table className="text-gray-800 bg-white w-full">
            ...
            <TableFooter className="bg-indigo-100 text-indigo-900 border-t border-indigo-200 rounded-b-xl">
