...
export default function RecordInsertDefault({
  ...
  return (
    <Dialog open={openDialog} onOpenChange={setOpenDialog}>
      <DialogContent
        className="h-[90vh] w-[80vw] max-w-none rounded-xl border shadow-lg overflow-hidden"
      ...
      >
        ...
        <div className="rounded-xl border border-indigo-300 overflow-hidden">
          <Table className="text-gray-800 bg-white w-full">
            <TableHeader className="uppercase bg-indigo-100 text-indigo-900 border-b border-indigo-200">
              <TableRow>
            ...
            <TableFooter className="bg-indigo-100 text-indigo-900 border-t border-indigo-200">
