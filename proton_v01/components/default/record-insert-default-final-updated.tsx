...
export default function RecordInsertDefault({
  ...
  return (
    <Dialog open={openDialog} onOpenChange={setOpenDialog}>
      <DialogContent
        className="h-[90vh] w-[80vw] max-w-none rounded-xl border shadow-lg"
      ...
      >
        ...
        <div className="relative overflow-x-auto px-6 space-y-8">
          <Table className="text-gray-800 bg-white border border-indigo-200 rounded-xl overflow-hidden shadow-[0_6px_20px_rgba(75,_85,_99,_0.25)]">
